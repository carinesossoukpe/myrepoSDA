...
![Figure 1](https://github.com/warint/DPR/blob/main/chapter2/images/fig1.png?raw=true)
...
![Figure 2](https://github.com/warint/DPR/blob/main/chapter2/images/fig2.png?raw=true)

## **Selected country commentaries**

The following section provides an overview of selected economies;

**Canada** is 14th globally, losing two places and 0.3 points since the 2018 assessment.<br>
**France** is up two notches over 2018 and now ranks 15th.<br>
